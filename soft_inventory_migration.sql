...
COMMENT ON COLUMN soft_inventory_variance.bacon_variance IS 'Bacon variance percentage (supports 2 decimal places, can be negative for shortage, positive for overage)';
COMMENT ON COLUMN soft_inventory_variance.beef_4oz_variance IS 'Beef 4oz variance percentage (supports 2 decimal places)';
COMMENT ON COLUMN soft_inventory_variance.beef_small_variance IS 'Beef Small variance percentage (supports 2 decimal places)';
COMMENT ON COLUMN soft_inventory_variance.chicken_breaded_variance IS 'Chicken Breaded variance percentage (supports 2 decimal places)';
COMMENT ON COLUMN soft_inventory_variance.chicken_diced_variance IS 'Chicken Diced variance percentage (supports 2 decimal places)';
COMMENT ON COLUMN soft_inventory_variance.chicken_nuggets_variance IS 'Chicken Nuggets variance percentage (supports 2 decimal places)';
COMMENT ON COLUMN soft_inventory_variance.chicken_nuggets_spicy_variance IS 'Chicken Nuggets Spicy variance percentage (supports 2 decimal places)';
COMMENT ON COLUMN soft_inventory_variance.chicken_patty_3_1_variance IS 'Chicken Patty 3.1 variance percentage (supports 2 decimal places)';
COMMENT ON COLUMN soft_inventory_variance.chicken_breaded_spicy_variance IS 'Chicken Breaded Spicy variance percentage (supports 2 decimal places)';
COMMENT ON COLUMN soft_inventory_variance.chicken_strips_variance IS 'Chicken Strips variance percentage (supports 2 decimal places)';
COMMENT ON COLUMN soft_inventory_variance.sausage_patty_variance IS 'Sausage Patty variance percentage (supports 2 decimal places)';

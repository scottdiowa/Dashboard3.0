-- Goals table rebuild for Dashboard 3.0
-- Run this in your Supabase SQL Editor to completely rebuild the goals table

-- First, let's drop the existing table and recreate it properly
DROP TABLE IF EXISTS public.goals CASCADE;

-- Create the goals table with the correct structure
...
CREATE INDEX idx_goals_store_period ON goals(store_id, period_start, period_end);
